...
public class RetryPolicy {
	...
	static final RetryPolicy NEVER = RetryPolicy.newBuilder().withMaxRetries(0).build();
	...
	public static class Builder {
		...
		public Builder(RetryPolicy other) {
			...
			this.abortConditions = other.abortConditions;
		}
		...
		/**
		 * Specifies when retries should be aborted. Any failure that is assignable from
		 * the {@code failure} will be result in retries being aborted.
		 * 
		 * @throws NullPointerException
		 *             if {@code failure} is null
		 */
		@SuppressWarnings({ "unchecked", "rawtypes" })
		public Builder abortOn(Class<? extends Throwable> failure) {
		...
		/**
		 * Specifies when retries should be aborted. Any failure that is assignable from
		 * the {@code failures} will be result in retries being aborted.
		 * 
		 * @throws NullPointerException
		...
		/**
		 * Returns whether an execution result can be aborted given the configured abort
		 * conditions.
		 * 
		...
		/**
		 * Returns whether an execution result can be retried given the configured abort
		 * conditions.
		 * 
		...
		/**
		 * Returns a copy of this RetryPolicy.Builder.
		 */
		public Builder copy() {
		...
		/**
		 * Specifies that a retry should occur if the {@code resultPredicate} matches
		 * the result and the retry policy is not exceeded.
		 * 
		 * @throws NullPointerException
		 *             if {@code resultPredicate} is null
		 */
		...
		/**
		 * Specifies the failure to retry on. Any failure that is assignable from the
		 * {@code failure} will be retried.
		 * 
		 * @throws NullPointerException
		 *             if {@code failure} is null
		 */
		@SuppressWarnings({ "rawtypes", "unchecked" })
		public Builder retryOn(Class<? extends Throwable> failure) {
			Assert.notNull(failure, "failure");
			return retryOn((List) Arrays.asList(failure));
		}

		/**
		 * Specifies the failures to retry on. Any failure that is assignable from the
		 * {@code failures} will be retried.
		 * 
		 * @throws NullPointerException
		 *             if {@code failures} is null
		 * @throws IllegalArgumentException
		...
		/**
		 * Specifies that a retry should occur if the {@code failurePredicate} matches
		 * the failure and the retry policy is not exceeded.
		 * 
		 * @throws NullPointerException
		 *             if {@code failurePredicate} is null
		 */
		 ...
		 *             {@link RetryPolicy.Builder#withMaxDuration(long, TimeUnit)
		 *             maxDuration}
		 * @throws IllegalArgumentException
		 *             if {@code delay} is <= 0 or {@code delay} is >= {@code maxDelay}
		 */
		 ...
		 *             maxDuration}
		 * @throws IllegalArgumentException
		 *             if {@code delay} <= 0, {@code delay} is >= {@code maxDelay}, or
		 *             the {@code delayFactor} is <= 1
		 */
		 ...
		 * {@code jitterFactor} will be added or subtracted to the delay. For example: a
		 * retry delay of {@code 100} milliseconds and a {@code jitterFactor} of
		 * {@code .25} will result in a random retry delay between {@code 75} and
		 * {@code 125} milliseconds.
		 * <p>
		 ...
		 * delay, a random portion of the {@code jitter} will be added or subtracted to
		 * the delay. For example: a {@code jitter} of {@code 100} milliseconds will
		 * randomly add between {@code -100} and {@code 100} milliseconds to each retry
		 * delay.
		 * <p>
		 * Jitter should be combined with {@link #withDelay(long, TimeUnit) fixed} or
		 * {@link #withBackoff(long, long, TimeUnit) exponential backoff} delays.
		 ...
		 *             if {@code jitter} is <= 0
		 * @throws IllegalStateException
		 *             if no delay has been configured or {@link #withJitter(double)}
		 ...
		 *             {@link RetryPolicy.Builder#withDelay(long, TimeUnit) delay}
		 */
