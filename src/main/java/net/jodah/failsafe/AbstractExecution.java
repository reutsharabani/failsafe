...
abstract class AbstractExecution extends ExecutionContext {
	...
	/**
	 * Creates a new Execution for the {@code retryPolicy} and
	 * {@code circuitBreaker}.
	 * 
	...
	/**
	 * Records and attempts to complete the execution, returning true if complete
	 * else false.
	 * 
	...
	boolean complete(Object result, Throwable failure, boolean checkArgs) {
		...
		boolean shouldRetry = !retriesExceeded && checkArgs && !isAbortable && retryPolicy.allowsRetries()
				&& isRetryable;
